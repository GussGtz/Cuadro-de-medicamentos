...
const conexion = mysql.createConnection({
  host: 'localhost', // Cambia "server" a "host"
  user: 'root',
  password: 'root',
...
app.post('/verificarUser', (peticion, respuesta) => {
  ...
  console.log(resultado); 
    ...
    // INSERTAMOS EN LA TABLA DE USUARIO_MEDICAMENTOS (DOSIS).
           ...
           const sqlInsertD = "INSERT INTO usuario_medicamento (id_usuario,medicamento,fecha_hora,cada_cuando,aplicado,dosis,duracion) VALUES (?, ?,?,?,1,?,?)";
