...
const MedicationChart = () => {
  	...
  	const [dosismaniana, setDescripcionDosisM] = useState('');
  	const [sigmaniana, setPeriodoDiaM] = useState('');
  	const [primeratomamaniana, setPriTomaM] = useState('');
  	const [fremaniana, setFreM] = useState('');
   
  	const [dosismedio, setDescripcionDosisMe] = useState('');
  	const [sigmedio, setPeriodoDiaMe] = useState('');
  	const [primeratomamedio, setPriTomaMe] = useState('');
  	const [fremedio, setFreMe] = useState('');
   
    const [dosistarde, setDescripcionDosisT] = useState('');
	const [sigtarde, setPeriodoDiaT] = useState('');
	const [primeratomatarde, setPriTomaT] = useState('');
	const [fretarde, setFreT] = useState('');
   
	const [dosisnoche, setDescripcionDosisN] = useState('');
	const [signoche, setPeriodoDiaN] = useState('');
	const [primeratomanoche, setPriTomaN] = useState('');
	const [frenoche, setFreN] = useState('');
            ...
            <tbody>
              {correspondingData.map((data, index) => (
                <tr key={index}>
                  ...
                  <td>{dosis[time.label][index].sigdo}</td>
                </tr>
              ))}
            </tbody>
          </table>
